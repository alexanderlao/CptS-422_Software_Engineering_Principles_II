...
public class MethodLimitCheck extends AbstractCheck {
    ...
    {	
    	if(process(root))
    	{
    		if(getTotalNotUniqueOperator() == min - 1 ||  getTotalNotUniqueOperator() == max + 1)
    		{
    			return -1;
    		}
    		else if(getTotalNotUniqueOperand() == min - 1 ||  getTotalNotUniqueOperand() == max + 1)
    		{
    			return -1;
    		}
    		else
    ...
    {	
    	if(process(root))
    	{
    		if(getTotalUniqueOperator() == min - 1 ||  getTotalUniqueOperator() == max + 1)
    		{
    			return -1;
    		}
    		else if(getTotalUniqueOperand() == min - 1 ||  getTotalUniqueOperand() == max + 1)
    		{
    			return -1;
    		}
    		else
    ...
    {	
    	if(process(root))
    	{
    		if(getTotalNotUniqueOperand() == min - 1 || getTotalNotUniqueOperand() == max + 1)
    		{
    			return -1;
    		}
    		else
    ...
    public double getVolume(DetailAST root)
    {
    	...
    	if(process(root))
    	{
    		...
    		else if(getTotalUniqueOperator() == min - 1 ||  getTotalUniqueOperator()== max + 1)
    		{
    			return -1;
    		}
    		else if(getTotalUniqueOperand() == min - 1 ||  getTotalUniqueOperand() == max + 1)
