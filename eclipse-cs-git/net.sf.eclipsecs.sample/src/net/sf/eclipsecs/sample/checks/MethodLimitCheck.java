...
public class MethodLimitCheck extends AbstractCheck {
    ...
    {
    	if((Double)N instanceof Double && (Double)n instanceof Double)
    	{
    ...
    {
    	if((Double)diff instanceof Double && (Double)vol instanceof Double)
    	{
    		return diff*vol;
    	}
    	else
    ...
    {
    	if((Double)uniqueOperator instanceof Double && (Double)totalOperand instanceof Double)
    	{
